...
Row {data-height=30}
-----------------------------------------------------------------------
Explore this map of shark attacks across Australia to better understand where certain types of attacks have occurred and where attacks might be more common, by selecting different attack characteristics and hovering over different points to learn more about the attacks!

Row {data-height=30}
-----------------------------------------------------------------------
Through looking at the maps, you can see that Queensland and New South Wales appear to have a much higher density of points along their coast. Queensland and Western Australia also appear to have the longest coasts, which might impact how many shark attacks occur in those states. Respective state populations could also influence the number of attacks and the proportion of different attack characteristics occurring in each state. There are also certain areas with higher clustering of certain characteristics.
...
Column {.sidebar}
-----------------------------------------------------------------------
This page shows time series and line and dot plots showing how the proportion and counts of different attack characteristics have changed over time (1800-2024). 
