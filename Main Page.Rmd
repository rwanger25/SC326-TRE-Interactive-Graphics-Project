...
shark_attacks_fixed <- shark_attacks %>%
  ...
  mutate(Victim.gender = case_when(Victim.gender == "female" ~ "Female",
                                   Victim.gender == "male" ~ "Male")) %>%
  mutate(Injury.severity = case_when(Injury.severity == "abrasion" ~ "Abrasion", 
                                     Injury.severity == "major lacerations" ~ "Major Lacerations", 
                                     Injury.severity == "minor lacerations" ~ "Minor Lacerations", 
                                     Injury.severity == "other: teeth marks" ~ "Other: Teeth Marks", 
                                     Injury.severity == "punctures" ~ "Punctures", 
                                     Injury.severity == "surface wound" ~ "Surface Wound")) %>%
  mutate(Site.category = case_when(Site.category == "coastal" ~ "Coastal",
                                   Site.category == "Coastal" ~ "Coastal",
                                   Site.category == "estuary/harbour" ~ "Estuary/Harbour", 
                                   Site.category == "island open ocean" ~ "Island Open Ocean", 
