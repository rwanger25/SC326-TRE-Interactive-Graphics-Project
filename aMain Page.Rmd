...
renderPlotly({
  if(input$response_var %in% barchart){
    ...
    barchart_plot <- ggplot(dataframe_barchart_ordered,
      ...
      #  geom_line(aes_string(x = "Year", y = ifelse(input$prop_count == "count", paste0("total_", input$response_var), NULL)), color = "black")+
      # geom_point(aes(x = Year, y = ifelse(input$prop_count == "count", paste0("total_", input$response_var), NULL)), color = "black")+
         labs(x = "Years",
      ...
      scale_color_manual(values = c("Fatal" = "#a50f15", "Injured" = "#ef3b2c", "Uninjured" = "#fcbba1", "Ocean/Pelagic" = "#343d6f", "Island Open Ocean" = "#045a8d", "Estuary/Harbour" = "#2b8cbe", "Coastal" = "#74a9cf",  "River" = "#a6bddb", "Other" = "grey40","Provoked" = "#8c3a40", "Unprovoked" = "#343d6b", "Swimming" = "#a6cee3", "Boarding" = "#1f78b4", "Spearfishing" = "#b2df4a", "Snorkeling" = "#33a02c", "Diving" = "#fb9a99", "Boating" = "#e31a1c", "Standing in Water" = "#fdbf6f", "Fishing" = "#ff7f00", "Other" = "#cab2d6",
          "Major Lacerations" = "#a50f15", "Minor Lacerations" = "#de2d26", "Punctures" = "#fb6a4a" , "Surface Wound" = "#fc9272", "Abrasion" = "#fcbba1", "Other: Teeth Marks" = "#fee5d9", "Male" = "#2b8cbe", "Female" = "#fb6f99"),
...
"<br>Years: ", dataframe_barchart_ordered$Year),
    ...
    lineplot_plot <- ggplot(data = dataframe_time(),
        ...
        geom_smooth(method = "loess", alpha = 0.2, color = alpha("blue", 0.3), figure = 'y~x', aes(text = tooltip_text_date)) +
        labs(x = "Date",
  ...
  # 
  # else if (input$response_var %in% lineplot) {
  # # Add a tooltip text column to the data
  # dataframe_time_with_tooltip <- dataframe_time() %>%
  #   mutate(
  #     tooltip_text = ifelse(input$response_var == "Victim.age",
  #                           paste0("<br>Victim Age: ", Victim.age, 
  #                                  "<br>Year: ", Incident.year),
  #                           ifelse(input$response_var == "attack_count", 
  #                                  paste0("<br>Attack Count: ", attack_count, 
  #                                         "<br>Year: ", Incident.year), 
  #                                  NA))
  #   )
  # 
  # # Create the plot with mapped tooltips
  # lineplot_plot <- ggplot(data = dataframe_time_with_tooltip,
  #                         aes_string(x = "Incident.year", y = input$response_var)) +
  #   geom_point(alpha = 0.6, size = 0.8, aes(text = tooltip_text)) + # Map tooltip to points
  #   geom_smooth(method = "loess", alpha = 0.2, formula = 'y ~ x', color = alpha("blue", 0.3)) + 
  #   labs(x = "Date",
  #        y = ifelse(input$response_var == "attack_count", "Number of Attacks", "Victim Age"),
  #        title = ifelse(input$response_var == "Victim.age", 
  #                       "Victim Age per Attack during Shark Attacks between 1800-2024", 
  #                       ifelse(input$response_var == "attack_count", 
  #                              "Number of Shark Attacks per Year between 1800-2024", ""))) +
  #   scale_x_date(date_breaks = "10 years", 
  #                date_labels = "%Y", 
  #                limits = c(as.Date("1802-01-01"), as.Date("2024-01-01"))) +
  #   theme(axis.text.x = element_text(angle = 45, vjust = 0.8)) +
  #   interactive_theme
  # 
  # # Return the plotly object with tooltips enabled
  # return(ggplotly(lineplot_plot, tooltip = "text"))
  #   }
